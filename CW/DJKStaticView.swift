...
class DJKStaticView: CATransformLayer {
    ...
    func setTheLeftSide(image:UIImage) {
        ...
        let leftImgRef = CGImageCreateWithImageInRect(tmpImageRef, CGRectMake(0, 0, image.size.width/2 * UIScreen.mainScreen().scale, image.size.height * UIScreen.mainScreen().scale))
